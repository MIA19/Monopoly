...
public class GameScreen extends JFrame
{
    ...
    public ArrayList createFieldList(Theme gameTheme){
        ...
        if(gameTheme == Theme.original) {
            ...
            list.add (new Field ("See Straße", 0, 0, FieldState.normalStreets, 140,100,50,150,450,625,750));            //Street
            list.add (new Field ("Elektrizitätswerk", 0, 0, FieldState.workField));
            list.add (new Field ("Hafen Straße", 0, 0, FieldState.normalStreets,140,100,50,150,450,625,750));          //Street
            list.add (new Field ("Neue Straße", 0, 0, FieldState.normalStreets, 160,100,60,180,500,700,900));           //Street
            list.add (new Field ("West Bahnhof", 0, 0, FieldState.trainStation));
            list.add (new Field ("Münchener Straße", 0, 0, FieldState.normalStreets, 180,100,70,200,550,750,950));      //Street
            list.add (new Field ("Gemeinschaftsfeld", 0, 0, FieldState.cardField));
            list.add (new Field ("Wiener Straße", 0, 0, FieldState.normalStreets));         //Street
            list.add (new Field ("Berliner Straße", 0, 0, FieldState.normalStreets));       //Street
            list.add (new Field ("Frei Parken", 0, 0, FieldState.freeParking));
            list.add (new Field ("Theater Straße", 0, 0, FieldState.normalStreets));        //Street
            list.add (new Field ("Ereignisfeld", 0, 0, FieldState.cardField));
            list.add (new Field ("Museums Straße", 0, 0, FieldState.normalStreets));        //Street
            list.add (new Field ("Opernplatz", 0, 0, FieldState.normalStreets));            //Street
            list.add (new Field ("Nord Bahnhof", 0, 0, FieldState.trainStation));
            list.add (new Field ("Lessing Straße", 0, 0, FieldState.normalStreets));        //Street
            list.add (new Field ("Schiller Straße", 0, 0, FieldState.normalStreets));       //Street
            list.add (new Field ("Wasser Werk", 0, 0, FieldState.workField));
            list.add (new Field ("Goethe Straße", 0, 0, FieldState.normalStreets));         //Street
            list.add (new Field ("Gehe ins Gefängnis", 0, 0, FieldState.goToPrison));
            list.add (new Field ("Rathaus Platz", 0, 0, FieldState.normalStreets));         //Street
            list.add (new Field ("Haupt Straße", 0, 0, FieldState.normalStreets));          //Street
            list.add (new Field ("GemeinschaftsFeld", 0, 0, FieldState.cardField));
            list.add (new Field ("Bahnhof Straße", 0, 0, FieldState.normalStreets));        //Street
            list.add (new Field ("Haupt Bahnhof", 0, 0, FieldState.trainStation));
            list.add (new Field ("Ereignisfeld", 0, 0, FieldState.cardField));
            list.add (new Field ("Park Straße", 0, 0, FieldState.normalStreets));           //Street
            list.add (new Field ("Zusatzsteuer", 0, 0, FieldState.taxField));
            list.add (new Field ("Schloss Allee", 0, 0, FieldState.normalStreets));         //Street
        }else if(gameTheme == Theme.lette){
            list.add (new Field ("Start", 0, 0, FieldState.startField));                    //Start
        }
